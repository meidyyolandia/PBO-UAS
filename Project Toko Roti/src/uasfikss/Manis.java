...
public class Manis extends Roti{
    ...
    public double hitungHargaAdonan() {
        ...
        this.hargaGulaPerAdonan = this.hargaGulaPerGram*150;
        this.hargaButterPerAdonan = this.hargaButterPerGram*150;
        this.hargaRagiPerAdonan = this.hargaRagiPerGram*20;
        this.hargaSusuBubukPerAdonan = this.hargaSusuBubukPerGram*300;
        this.hargaSusuCairPerAdonan = this.hargaSusuCairPerGram*250;
        this.hargaTelurPerAdonan = this.hargaTelurPerGram*80;
        this.hargaEsBatuPerAdonan = this.hargaEsBatuPerGram*400;
    ...
    public double hitungHargaPerPCS() {
        double jumlahPcsPerAdonan = 2350/50;
        hitungHargaAdonan();
    ...
    public void hitungBeratAdonanTotal(){
        ...
        this.beratGulaPerPesanan = (150/jumlahPcsPerAdonan)*this.jumlahPesanan;
        this.beratButterPerPesanan = (150/jumlahPcsPerAdonan)*this.jumlahPesanan;
        this.beratRagiPerPesanan = (20/jumlahPcsPerAdonan)*this.jumlahPesanan;
        this.beratSusuBubukPerPesanan = (300/jumlahPcsPerAdonan)*this.jumlahPesanan;
        this.beratSusuCairPerPesanan = (250/jumlahPcsPerAdonan)*this.jumlahPesanan;
        this.beratTelurPerPesanan = (80/jumlahPcsPerAdonan)*this.jumlahPesanan;
        this.beratEsBatuPerPesanan = (400/jumlahPcsPerAdonan)*this.jumlahPesanan;
